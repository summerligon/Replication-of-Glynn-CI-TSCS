...
pdf(file=here::here("output/fig5-sim.pdf"), width = 10, height = 10, pointsize = 14)
...
pdf(file=here::here("output/adl-snmm-msm-bias.pdf"), width = 10, height = 10, pointsize = 14)
par(mfrow = c(2,2), oma = c(2, 0.5, 0.5, 0.5))
for (j in 2:3) {
...
pdf(file=here::here("output/adl-snmm-msm-t-rmse.pdf"), width = 10, height = 5, pointsize = 14)
...
pdf(file=here::here("output/adl-snmm-msm-t-bias.pdf"), width = 10, height = 5, pointsize = 14)
par(mfrow = c(1,2), oma = c(2, 0.5, 0.5, 0.5))
...
pdf(file=here::here("output/adl-snmm-msm-cet-rmse.pdf"), width = 10, height = 10, pointsize = 14)
par(mfrow = c(2,2), oma = c(2, 0.5, 0.5, 0.5))
for (j in 2:3) {
...
pdf(file=here::here("output/adl-snmm-msm-cet-bias.pdf"), width = 10, height = 10, pointsize = 14)
par(mfrow = c(2,2), oma = c(2, 0.5, 0.5, 0.5))
for (j in 2:3) {
...
pdf(file=here::here("output/miss-z-rmse.pdf"), width = 10, height = 10, pointsize = 14)
par(mfrow = c(2,2), oma = c(2, 0.5, 0.5, 0.5))
for (j in 1:4) {
  inds <- ind.list[[j]]
